...
| [`static-network/`](./static-network) | Full tenant override: timezone, locale, disk device, admin user, SSH key, static IP/prefix/gateway/DNS/domain. The "this is how you really configure a host" example. |
